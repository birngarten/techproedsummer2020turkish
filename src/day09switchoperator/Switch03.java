...
public class Switch03 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Ay Ýsmini Girin");
		String ay = scan.next();
		ay= ay.toLowerCase(); // toLowerCase(); ==> Bu method String'leri kucuk harfe cevirmek icin kullanýlýr.
							  // toUpperCase(); ==> Bu method String'leri buyuk harfe cevirmek icin kullanýlýr.
