...
public class InterviewSorusu01 {
	...
	public static void main(String[] args) {
		 ...
		 // Ýki tane variable'in degerlerini yer degistiriniz.
		// sayi = 12, sayi2 = 30 ==> oyle bir islem yapinki sayi1 = 30, sayi2=12 olsun. ( BU isleme Swap denir)
		...
		System.out.println("Yer degistirdikten once");
		System.out.println(sayi1);//12.0
		System.out.println(sayi2);//30.0
		
		double gecici = 0.0; //variable olusturken data type sadece bir kere yazilir.
		gecici= sayi1;
		sayi1 = sayi2;
		sayi2 = gecici;
