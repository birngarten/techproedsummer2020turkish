...
public class ListAllMethod {
	...
	public static void main(String[] args) {
		...
		// *****addAll()****** methodu iki listi birleştirmek için kullanılır.
		...
		System.out.println(list4);//[2, 1, 3]//iki list'i birleştirirken istersek index ile list'in istenilen bir yerine ekleme yapılabilir.
