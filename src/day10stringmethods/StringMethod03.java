...
public class StringMethod03 {
	...
	public static void main(String[] args) {
        ...
        System.out.println(str1.charAt(8));// Burada (9) yazýlýrsa Olmayan bir index ile islem yapýlýrsa console 
                                            //"Exception" uyarisi cýkar. Bu da buyuk bir hata yaptiniz demektir.
        
        // length() methodu Stringin icinde kac character oldugunu verir
        System.out.println(str1.length());// Ekrana 9 yazdirir. 
        								  // index saymaya 0 dan baslar fakat
