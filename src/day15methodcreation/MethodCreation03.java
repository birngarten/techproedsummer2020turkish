...
public class MethodCreation03 {
	...
	public static void main(String[] args) {
		// Hesap Makinasý
		// Kullanýcýdan yapacagi iþlemi iþlem sembolü ile secmesini saglayalým.
		// Kullanýcýdan iki sayý girmesini isteyelim
		// Girilen sayýlar ve secilen iþleme göre dogru sonucu ekrana yazalým.
	...
	public static void hesapMakinasi(char islem, double num1, double num2) {
		...
		case ':':
			...
			break;
		default:
			System.out.println("+, -, x, : dýsýnda sembol girmeyiniz");
		}
	}
